...
function Home() {
  ...
  return (
    ...
    <div className=''>
      ...
      <ShowItem setTasks={setTasks} selectedTask={selectedTask} setSelectedTask={setSelectedTask}/>
      <CreateTaskform visible={visibleCreateTaskForm} setTasks={setTasks} setVisible={setVisibleCreateTaskForm}/>
      <AddButton visible={visibleCreateTaskForm} setVisible={setVisibleCreateTaskForm} />
    </div>
  )
